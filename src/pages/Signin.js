                    ...
                    <div className='w-full border border-zinc-200 p-6'>
                        ...
                        <div className='flex flex-col gap-3'>
                            <div className='flex flex-col gap-2'>
                                ...
                                {
                                    formError.email ?
                                        <input className="w-full lowercase py-1 border border-red-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100" autocomplete="off" type="email" name='email' onChange={handleChangeInput} value={formValues.email} />
                                        :
                                ...
                                {/* <input className="w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100" type="email" onChange={handleChangeInput}/> */}
                            ...
                            <div className='flex flex-col gap-2'>
                                ...
                                {/* <input className="w-full lowercase py-1 border border-zinc-400 px-2 text-base rounded-sm outline-none focus-within:border-[#e77600] focus-within:shadow-amazonInput duration-100" type="password" onChange={handleChangeInput}/> */}
