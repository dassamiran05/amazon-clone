            ...
            <Slider {...settings}>
                {
                    elecProducts.map(product => (
                        <div className='px-1.5' key={product.id}>
                            <div key={product.id} className="bg-[#f7f8f8] product-i h-[220px] items-center justify-center cursor-pointer shadow-none duration-200 p-3 border-[1px] border-gray-200">
